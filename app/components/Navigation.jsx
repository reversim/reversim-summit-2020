        ...
        <div className={cx("container")}>
          <div className={cx("col-sm-2", "col-xs-12", "navigation-header")}>
            <Link to="/" className={cx("logo")}>
              <img src={logoImg} alt="Reversim" width="143" height="63" className={cx("retina-hide", "display-block")} />
              <img src={logoImg2x} alt="Reversim" width="119" height="53" className={cx("retina-show", "display-block")} />
            </Link>
