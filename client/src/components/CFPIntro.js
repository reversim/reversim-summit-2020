...
const CFPIntro = () => (
  <div className="pb-6 mb-8 border-bottom">
    ...
    <p>We want deep, technical sessions. We are not looking for “intro to something software” or “something software 101”. We’re looking for something of greater depth. An interesting project you worked on, research, etc. Not entry level.</p>
    <p>However, we are open to session “intro to something that isn’t software”, as long is this something is of general interest, for example “intro to moonwalking and breakdance”.</p>
