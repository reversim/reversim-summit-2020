...
const CalendarLink = () => (
	<div>
		...
		<p>Clicking here will download an .ics file, which can be imported into any calendar app and contains the schedule for easy viewing and notifications during the event.</p>
	</div>
);
