      ...
      <section className={s.hero}>
        <div className={cn(s.heroInner, 'ml-auto font-amstelvar text-center')}>
          ...
          <div className={cn('h4 d-inline-block mb-8 text-left')}>
            <div>
              <i className="fa fa-calendar-o mr-3 mb-3" />
              <span>8 - 9 . Oct</span>
            </div>
            <div>
              <i className="fa fa-map-marker mr-3 ml-1" />
              ...
              {votingEnded && (
                <Fragment>
                  ...
                  <h4 className="mb-0 font-weight-normal">
                    Please stay tuned for when we publish the schedule and open registration
                  </h4>
                </Fragment>
              )}
            </div>
          ...
          <div className="text-center">
            <a
              className="text-white font-size-lg mr-4"
            ...
            <a
              ...
              href="https://groups.google.com/forum/#!forum/reversim-summit"
              target="_blank"
              rel="noopener noreferrer">
