  ...
  <MainContainer>
    ...
    <SegmentContainer>
      ...
      <TopicsList>
        ...
        <ListItem><ListBolt icon={faChevronRight} />Low level / kernel / drivers / file systems / network</ListItem>
        <ListItem><ListBolt icon={faChevronRight} />Software design / programming languages / API design / software fundamentals</ListItem>
        <ListItem><ListBolt icon={faChevronRight} />Open source projects / technical / maintainership / personal experience / culture</ListItem>
        <ListItem><ListBolt icon={faChevronRight} />Customer facing development / UX / design / product / marketing</ListItem>
        <ListItem><ListBolt icon={faChevronRight} />Culture / scaling organizations / management / motivation and employee engagement</ListItem>
        <ListItem><ListBolt icon={faChevronRight} />Education / teaching / initiatives / government</ListItem>
      </TopicsList>
      <Paragraph2>
    ...
    <SegmentContainer>
      ...
      <GuidelinesList>
        <ListItem>
        <ListBolt icon={faChevronRight} /> Write a clear and concise proposal. The audience should know what to expect when they step into your session.
        </ListItem>
        <ListItem>
        <ListBolt icon={faChevronRight} />Please consider some past years suggestions on what we consider to be good content/proposals:
          <SubList>
            <ListItem>
              <ListBolt icon={faChevronCircleRight} />Watch our team explain what makes a <InvertedColorLink href="https://www.youtube.com/watch?v=Da-JcEYBjuo">good submission</InvertedColorLink>
            </ListItem>
            <ListItem>
              <ListBolt icon={faChevronCircleRight} />Watch Adam describe <InvertedColorLink href="https://www.youtube.com/watch?v=F09My4646hI">how to submit a proposal and how we choose them</InvertedColorLink>
            </ListItem>
          </SubList>
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />Avoid sales, marketing pitches, or self promotion.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />The conference is held in Hebrew, and sessions should be delivered in Hebrew. If a speaker does not speak the language, the session will be presented in English.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />A speaker may submit up to three (3) proposals.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />A session may be presented by up to two speakers. All speakers <Italic>must</Italic> be indicated on submission.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />Assuming your session is accepted, our moderators will be in continuous contact with you, and follow up on your progress. <Italic>Your cooperation is expected and may be required.</Italic>
          Not being able to cooperate or respond in a timely manner may endanger your participance.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />You will be requested to participate in at least one dry run session.
          Your presentation at the conference may depends on that dry run. <Italic>In our experience, speakers consider the dry run as beneficial to their presentation and personal preparation.</Italic>
        </ListItem>
      </GuidelinesList>
    ...
    <SegmentContainer>
      ...
      <ul>
        <ListItem> 
          <ListBolt icon={faChevronRight} />Once the Call for Papers closes, our moderation team will begin reviewing proposals.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />Reviewing is not anonymous.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />We will also hold a public vote to measure demand and interest. Results of this vote will remain confidential.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />Moderators may contact submitters for questions & clarifications.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />At the end of the proposal selection process, and before schedule is published, all submitters will be notified on their proposal status.
        </ListItem>
        <ListItem>
          <ListBolt icon={faChevronRight} />A few speakers may be contacted to agree to have their session waitlisted, so that they can be scheduled in case of another session’s last moment cancellation.
        </ListItem>
      </ul>
    </SegmentContainer>
