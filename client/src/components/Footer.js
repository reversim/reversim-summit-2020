...
const Footer = ({isSmallScreen}) => (
  <footer className="bg-purple3 py-6 font-size-md mt-13">
    <Container>
      ...
      <Row
        className={cn("justify-content-center justify-content-lg-between text-white", isSmallScreen ? "d-flex flex-column w-max-content" : "align-items-center")}
        noGutters
      >
        <div className={cn("d-flex", isSmallScreen && 'flex-column')}>
          ...
          <a className={cn("text-white", !isSmallScreen && "ml-12")} href="http://confcodeofconduct.com/">
            Code of Conduct
          </a>
        </div>
